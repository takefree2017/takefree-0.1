...
public class ShareCategoryQuery {
     ...
     * @mbg.generated
     */
    public ShareCategoryQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShareCategoryQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShareCategoryQuery page(Integer page, Integer pageSize) {
