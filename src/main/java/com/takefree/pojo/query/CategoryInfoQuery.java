...
public class CategoryInfoQuery {
     ...
     * @mbg.generated
     */
    public CategoryInfoQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public CategoryInfoQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public CategoryInfoQuery page(Integer page, Integer pageSize) {
