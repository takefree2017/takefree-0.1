...
public class ShowCounterQuery {
     ...
     * @mbg.generated
     */
    public ShowCounterQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShowCounterQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShowCounterQuery page(Integer page, Integer pageSize) {
