...
public class ShowPicQuery {
     ...
     * @mbg.generated
     */
    public ShowPicQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShowPicQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShowPicQuery page(Integer page, Integer pageSize) {
