...
public class ShowPicQuery extends BaseQuery implements Serializable {
     ...
     */
        ...
        public Criteria andSequenceLike(Integer value) {
            addCriterion("sequence like", value, "sequence");
            return (Criteria) this;
        }

        public Criteria andSequenceNotLike(Integer value) {
