...
public class ShowLikeQuery {
     ...
     * @mbg.generated
     */
    public ShowLikeQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShowLikeQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShowLikeQuery page(Integer page, Integer pageSize) {
