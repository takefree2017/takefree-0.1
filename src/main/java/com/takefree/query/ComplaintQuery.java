...
public class ComplaintQuery {
     ...
     * @mbg.generated
     */
    public ComplaintQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ComplaintQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ComplaintQuery page(Integer page, Integer pageSize) {
