...
public class UserAddressQuery {
     ...
     * @mbg.generated
     */
    public UserAddressQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public UserAddressQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public UserAddressQuery page(Integer page, Integer pageSize) {
