...
public class OrderRateQuery extends BaseQuery implements Serializable {
     ...
     */
        ...
        public Criteria andRateLike(Integer value) {
            addCriterion("rate like", value, "rate");
            return (Criteria) this;
        }

        public Criteria andRateNotLike(Integer value) {
