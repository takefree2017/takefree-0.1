...
public class SharePicQuery {
     ...
     * @mbg.generated
     */
    public SharePicQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public SharePicQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public SharePicQuery page(Integer page, Integer pageSize) {
