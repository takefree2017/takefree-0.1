...
public class ShareLikeQuery {
     ...
     * @mbg.generated
     */
    public ShareLikeQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShareLikeQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public ShareLikeQuery page(Integer page, Integer pageSize) {
