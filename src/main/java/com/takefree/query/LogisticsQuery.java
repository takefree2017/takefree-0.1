...
public class LogisticsQuery {
     ...
     * @mbg.generated
     */
    public LogisticsQuery limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public LogisticsQuery limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @mbg.generated
     */
    public LogisticsQuery page(Integer page, Integer pageSize) {
